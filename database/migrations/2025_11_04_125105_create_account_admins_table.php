...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        DB::unprepared('
            CREATE TRIGGER trg_generate_admin_id BEFORE INSERT ON account_admins
            FOR EACH ROW
            BEGIN
                DECLARE nextId INT;
                ...
                SET NEW.admin_id = CONCAT("ADM-", 10000 + nextId);
            END;
        ');
    }
    ...
    {
        DB::unprepared('DROP TRIGGER IF EXISTS trg_generate_admin_id');
