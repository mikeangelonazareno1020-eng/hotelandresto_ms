...
class AdministratorHotelController extends Controller
{
    ...
    public function bookingPage(Request $request)
    {
        ...
        return view('admin.hotel_side.adminBooking', [
    ...
    public function bookingCreate()
    {
        ...
        // Pass to view
        return view('admin.hotel_side.adminBookingForm', compact('rooms'));
    }
    ...
    public function checkinPage($reservationId)
    {
        ...
        return view('admin.hotel_side.adminBookingCheckinPage', compact(
            'reservation',
            'receipts',
            'addedAmenityNames',
            'downpaymentAmount',
    ...
    public function checkoutPage($reservationId)
    {
        ...
        return view('admin.hotel_side.adminBookingCheckoutPage', compact(
            'reservation',
            'receipts',
            'addedAmenityNames',
            'downpaymentAmount',
    ...
    public function cancelPage($reservationId)
    {
        ...
        return view('admin.hotel_side.adminBookingCancelPage', compact(
            'reservation',
            'receipts',
            'addedAmenityNames',
            'downpaymentAmount',
    ...
    public function detailsPage($reservationId)
    {
        ...
        // ✅ Return same structure & naming as Check-In
        return view('admin.hotel_side.adminBookingDetailsPage', compact(
            'reservation',
            'receipts',
            'addedAmenityNames',
            'downpaymentAmount',
    ...
    public function roomsIndex()
    {
        ...
        return view('admin.hotel_side.adminRooms', compact('rooms'));
    }
